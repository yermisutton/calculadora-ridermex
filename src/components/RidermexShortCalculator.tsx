...
interface RidermexShortCalculatorProps {
  onBack: () => void;
}

const RidermexShortCalculator: React.FC<RidermexShortCalculatorProps> = ({ onBack }) => {
  ...
  const steps = [
    {
      ...
      componentProps: { currentStep: 1, totalSteps: 5 },
      icon: Globe,
  ...
  const extraProps = (steps[currentStep] as any).componentProps || {};
    ...
    return (
      <div className="min-h-screen bg-dark-bg">
        ...
        <div className="container mx-auto px-4 py-8 pb-32">
          <CurrentStepComponent onNext={handleNext} onPrevious={handlePrevious} {...extraProps} />
        </div>
      </div>
    );
  }
...
export default RidermexShortCalculator;
