...
import { Download, FileText, CheckCircle, User, Phone, Mail, Globe } from 'lucide-react';
import { useCalculator } from '../../context/CalculatorContext';
import { generateSpecializedHTMLReport, ReportType } from '../../utils/htmlReportGenerator';
  ...
  const getDefaultButtonText = () => {
    switch (reportType) {
      case 'compound-multiplier':
        return 'Reporte HTML Multiplicador';
      case 'comparative-analysis':
        return 'Reporte HTML Comparativo';
      case 'certificate-evolution':
        return 'Reporte HTML Evolución';
      default:
        return 'Generar Reporte HTML';
    }
  };
          ...
          <div className="bg-white rounded-2xl shadow-xl max-w-md w-full p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 text-sm">
                Completa la información del asesor para generar el reporte HTML personalizado
              </p>
            </div>
